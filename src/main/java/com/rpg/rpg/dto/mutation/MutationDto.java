package com.rpg.rpg.dto.mutation;
...
public final class MutationDto {
    ...
    private MutationDto(@NotNull String id, @NotNull @NotEmpty String dice, @Nullable String god, @NotNull @NotEmpty String name, @NotNull @NotEmpty byte fearPoints, @NotNull @NotEmpty String type, @NotNull @NotEmpty String description, @Nullable String variants, @Nullable List<MutationEffects> mutationEffects, @Nullable String comments) {
        this.id = id;
        this.dice = dice;
        this.god = god;
        this.name = name;
    ...
    public static MutationDto of(final String id,
                                 final String dice,
                                 final String god,
                                 final String name,
