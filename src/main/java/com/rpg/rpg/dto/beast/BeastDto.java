...
public class BeastDto {
    ...
    public static BeastDto of(final String id,
                              final String name,
        ...
        return new BeastDto(id,name,description,img,mainTraits,secondaryTraits,skillEntities,abilityEntities,specialRules,armorEntities,armorPoints,weaponEntity,difficulty);
    }
}
