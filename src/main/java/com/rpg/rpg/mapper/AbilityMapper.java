...
public class AbilityMapper {
    ...
    public static AbilitiesDto toDto(List<AbilityEntity> abilityEntities){
        return AbilitiesDto.of(abilityEntities.stream().map(ability ->AbilityDto.of(ability.getId(),ability.getName(),ability.getDescription())).collect(Collectors.toList()));
    }
}
