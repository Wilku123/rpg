...
public class WeaponMapper {
    ...
    public static WeaponEntity fromDto(WeaponDto weaponDto){
        return new WeaponEntity(weaponDto.getId(),
                weaponDto.getName(),
                weaponDto.getPrice(),
                weaponDto.getWeight(),
    ...
    public static WeaponDto toDto(WeaponEntity weaponEntity){
        return WeaponDto.of(weaponEntity.getId(),
    ...
    public static WeaponsDto toDto(List<WeaponEntity> weaponEntities){
        return WeaponsDto.of(weaponEntities.stream().map(weapon-> WeaponDto.of(weapon.getId(),
                weapon.getName(),
                weapon.getPrice(),
                weapon.getWeight(),
                weapon.getCategory(),
                ...
                weapon.getAccessibility())).collect(Collectors.toList()));
    }
}
