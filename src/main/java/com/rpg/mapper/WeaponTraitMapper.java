...
public class WeaponTraitMapper {
    public static WeaponTraitDto toDto(WeaponTraitEntity weaponTraitEntity){
        return WeaponTraitDto.of(
                weaponTraitEntity.getId(),
                weaponTraitEntity.getName(),
                weaponTraitEntity.getDescription()
        );
    }

    public static WeaponTraitsDto toDto(List<WeaponTraitEntity> weaponEntities) {
        return WeaponTraitsDto.of(
                weaponEntities
                        .stream()
                        .map(trait -> WeaponTraitDto.of(
                                trait.getId(),
                                trait.getName(),
    ...
    public static WeaponTraitEntity fromDto(WeaponTraitDto weaponTraitDto) {
        return new WeaponTraitEntity(
                weaponTraitDto.getId(),
                weaponTraitDto.getName(),
                weaponTraitDto.getDescription()
        );
    }
}
